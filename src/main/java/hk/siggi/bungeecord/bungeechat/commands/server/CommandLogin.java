	...
	public void execute(CommandSender cs, String[] strings) {
		...
		switch (result) {
			...
			case "IP_MISMATCH":
				...
				MessageSender.sendMessage(p, "&6Make sure you got this code from &dhttps://cubebuilders.net &6and &c&onot&r&6 from a different website or from someone who asked you to type it in!");
				MessageSender.sendMessage(p, "&e======================================================");
				if (extraData != null) {
				...
				MessageSender.sendMessage(p, "&6If the code was generated by you, </login " + code + " no-check-ip><click here to continue the login>.");
				MessageSender.sendMessage(p, "&6If it was NOT generated by you, do not click to continue the login.");
				MessageSender.sendMessage(p, "&e======================================================");
