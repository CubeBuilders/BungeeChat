...
public class CommandSocialMedia extends Command implements TabExecutor {
	...
	public void execute(CommandSender cs, String[] args) {
		cs.sendMessage(unify(processChat(null, "&6Check out our social media pages!")));
		...
		cs.sendMessage(unify(processChat(null, "<https://www.instagram.com/cube.builders/><&eClick for our Instagram page!> &6(<https://www.instagram.com/cube.builders/><&e@cube.builders>)")));
		cs.sendMessage(unify(processChat(null, "<https://www.facebook.com/CubeBuilders/><&5Click for our Facebook page!>")));
	}
